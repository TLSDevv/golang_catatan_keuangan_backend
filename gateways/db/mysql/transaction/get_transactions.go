...
func (r Repository) GetActiveTransactions(ctx context.Context) ([]entities.Transaction, error) {
	sql := `
		SELECT
			id, transaction_name, category, transaction_type, amount, transaction_at, created_at, updated_at, deleted_at
		FROM
...
func (r Repository) GetInActiveTransactions(ctx context.Context) ([]entities.Transaction, error) {
	sql := `
		SELECT
			id, transaction_name, category, transaction_type, amount, transaction_at, created_at, updated_at, deleted_at
		FROM
